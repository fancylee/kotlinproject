...
import com.example.kotlin.activity.VideoDetailActivity
import com.example.kotlin.durationFormat
...
//            val pair = Pair<View, String>(view, VideoDetailActivity.IMG_TRANSITION)
            val activityOptions = ActivityOptionsCompat.makeSceneTransitionAnimation(
                    activity, androidx.core.util.Pair(view, VideoDetailActivity.IMG_TRANSITION))
